...
export class ApiStack extends Stack {
    ...
    private createApi(
        ...
        const domainNameMapping = new apigwv2.DomainName(this, 'ApiDomainName', {
            ...
            certificate: acm.Certificate.fromCertificateArn(this, 'cert', acmCertArn),
        });

        const api = new apigwv2.HttpApi(this, `Api${name}`, {
            apiName: name,
            defaultAuthorizer: authorizer,
            defaultDomainMapping: { domainName: domainNameMapping },
        });
